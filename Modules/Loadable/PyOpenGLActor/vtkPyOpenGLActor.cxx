...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkPyOpenGLActor); 

//----------------------------------------------------------------------------
vtkPyOpenGLActor::vtkPyOpenGLActor()
{
  this->Script = NULL;
}
...
//
// This is essenitally the core of vtkPyOpenGLActor, but with the call
// to the mapper replaced by the invocation of a script.
...
//
void vtkPyOpenGLActor::Render(vtkRenderer *ren, vtkMapper *vtkNotUsed(mapper))
{
  if (this->Script == NULL){
...
//----------------------------------------------------------------------------
void vtkPyOpenGLActor::PrintSelf(ostream& os, vtkIndent indent)
{
  if ( this->Script )
    {
